...
namespace LeHospital.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult ReceptionistLogin(string returnUrl)
        {
            ViewBag.ReturnUrl = returnUrl;
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ReceptionistLogin(LoginViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> PatientLogin(Patient model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> DoctorLogin(Doctor model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        // GET: /Account/Register
        [AllowAnonymous]
        public ActionResult ReceptionistRegister()
        {
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ReceptionistRegister(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> PatientRegister(Patient model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> DoctorRegister(Doctor model, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (file != null && file.ContentLength > 0)
                    {
                        ...
                        string imagepath = Path.Combine(Server.MapPath("~/DoctorsImages/"), filename);
                        //Just to try: string h = filename + imagepath;
            ...
            // If we got this far, something failed, redisplay form
            ViewBag.SpecialityId = new SelectList(db.Specialties, "Id", "Name", model.SpecialityId);
            return View(model);
        }
